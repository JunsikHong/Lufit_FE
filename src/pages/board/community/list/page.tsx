...
const dummyPosts: PostItem[] = [
  ...
  { id: 4, title: "러닝 초보 팁", content: "처음 시작하는 분들 꼭 보세요", author: "runner", likes: 25, comments: 7, createdAt: "2026-04-26", category: "러닝", }, 
  { id: 5, title: "러닝 초보 팁", content: "처음 시작하는 분들 꼭 보세요", author: "runner", likes: 25, comments: 7, createdAt: "2026-04-26", category: "러닝", },
  { id: 6, title: "다이어트 식단 질문", content: "이렇게 먹어도 될까요?", author: "user123", likes: 8, comments: 10, createdAt: "2026-04-27", category: "식단", }, 
];
